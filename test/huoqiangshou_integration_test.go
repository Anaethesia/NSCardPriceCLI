...
// TestHuoqiangshouReal queries 火枪手 for a few known-good game IDs.
func TestHuoqiangshouReal(t *testing.T) {
	requireIntegration(t)
	m := merchantByName(t, "huoqiangshou")

	ids := []game.MerchantEntry{
		{GameID: "641"},  // 塞尔达传说 旷野之息
		{GameID: "2475"}, // 塞尔达传说 王国之泪
		{GameID: "1269"}, // 马里奥赛车 8 豪华版
	}

	for _, entry := range ids {
		pause()
		t.Run("huoqiangshou-"+entry.GameID, func(t *testing.T) {
